;;; The bottom layer: (llvm raw) is the C API verbatim. The import
;;; prefix LLVM reconstructs the exact C names -- LLVMContextCreate
;;; here IS LLVMContextCreate in llvm-c. No safety nets down here.
...
(define fnty (base:call-with-pointer-array (list i32 i32)
