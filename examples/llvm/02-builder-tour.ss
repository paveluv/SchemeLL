;;; The (llvm ir) builder layer by hand: blocks, a phi loop, and the printer --
;;; everything sll:build does, spelled out.
...
[ir:phi-add-incoming!
 n
 (list (cons (ir:function-param f 0) entry) (cons n1 loop))]

[ir:phi-add-incoming!
 steps
 (list (cons (ir:const-int i64 0) entry) (cons steps1 loop))]
