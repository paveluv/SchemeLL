;;; The verifier and error discipline: broken IR raises a Scheme
;;; condition with LLVM's diagnosis, instead of crashing.
...
(guard (e [#t (printf "verifier said:~%~a~%" (condition-message e))])
  (ir:verify-module m)
