...
;;;
;;; The `prefix` import modifier acts as a namespace: every export of (llvm ir)
;;; is visible here as ir:<name>, every export of (llvm jit) as jit:<name>.
;;; (llvm jit) exports carry no prefix of their own for exactly this reason.
(import (chezscheme) (prefix (llvm ir) ir:) (prefix (llvm jit) jit:))
...
[ir:build-ret
 b
 (ir:build-add b (ir:function-param f 0) (ir:function-param f 1))]
