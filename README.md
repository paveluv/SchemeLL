...
environment. The Linux and FreeBSD rows link to exact commands, environment
records and logs, including the LLVM 16 compatibility checks and matching
regression corpus. Counts in historical rows retain their reported scope.
